...
func CreateCategoryHandler(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
...
func main() {
    lambda.Start(CreateCategoryHandler)
}