...
func DeleteCategoryHandler(ctx context.Context, event events.APIGatewayProxyRequest, userCtx *models.UserContext) (events.APIGatewayProxyResponse, error) {
...
func main() {
	lambda.Start(middleware.WithCORS(middleware.WithAuth(DeleteCategoryHandler)))
}
