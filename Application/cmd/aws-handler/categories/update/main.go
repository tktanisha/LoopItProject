...
func UpdateCategoryHandler(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
...
func main() {
    lambda.Start(UpdateCategoryHandler)
}